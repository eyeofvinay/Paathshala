...
if(session==null)
{
    ...
    Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/test","root","root");
     PreparedStatement st=con.prepareStatement("select * from teacherinfo where UserId=?");
        ...
        PreparedStatement st1=con.prepareStatement("select * from teacherdetails where TeacherId=?");
        st1.setString(1,value);     
        ResultSet rs1=st1.executeQuery();
        if(rs1.next())
        {
            qualification=rs1.getString(2);
            experience=rs1.getString(3);
            contact1=rs1.getString(5);           
        }
      ...
      out.write("            <a href=\"ViewReview.jsp\" class=\"links\" style=\"color:#f4f4f4; font-size: 16px; font-family: Verdana;\">View Review</a>\n");
      out.write("        </div>\n");
      ...
      out.write("            <a href=\"TeacherPage.jsp\" class=\"links\" style=\"color:#f4f4f4; font-size: 16px; padding-top: 30px; font-family: Verdana;\">Home</a>\n");
      out.write("        </div>\n");
      out.write("    </div>\n");
      out.write("        \n");
      ...
      out.write("                    <img src=\"settings.jpg\" width=\"21px\" height=\"20px\"> &nbsp;&nbsp;Settings\n");
      out.write("                    </a>\n");
      out.write("                </td>\n");
      out.write("            </tr>\n");
      out.write("            <tr>\n");
      ...
      out.write("                    <img src=\"greylogout1.jpg\" width=\"21px\" height=\"20px\"> &nbsp;&nbsp;Logout\n");
      out.write("                    </a>\n");
      out.write("                </td>\n");
      out.write("            </tr>\n");
      out.write("            <tr>\n");
      out.write("                <td class=\"tdtheme\">\n");
      out.write("                    <a href=\"ContactUs.jsp\" class=\"links\">\n");
      out.write("                    <img src=\"contact.png\" width=\"22px\" height=\"21px\"> &nbsp;&nbsp;Contact us\n");
      out.write("                    </a>\n");
      out.write("                </td>\n");
      out.write("            </tr>\n");
      out.write("        </table>\n");
      ...
      out.write("        <h1 style=\"color:#f4f4f4; padding-top: 10px; font-size: 25px; align-content: center; margin-left: 50px; font-family: Verdana; font-weight: normal;\">My Profile</h1>\n");
      out.write("        <form class=\"register\">\n");
      out.write("            <table>\n");
      out.write("                <tr>\n");
      out.write("                    <td class=\"tdtheme\">\n");
      out.write("                        <font style=\"font-family:Arial;font-size:32px; font-weight: bold;\">\n");
      out.write("                        ");
      out.print(name);
      out.write("\n");
      out.write("                        </font> \n");
      out.write("                        <br>\n");
      out.write("                        <br>\n");
      out.write("                        <font style=\"font-family:Arial;font-size:21px; font-weight: normal;color: slategray; \">\n");
      out.write("                        ");
      out.print(userId);
      out.write("\n");
      out.write("                        </font>\n");
      ...
      out.write("                        </font>\n");
      out.write("                        <br><br>\n");
      out.write("                        <font style=\"font-family:Arial;font-size:21px; font-weight: normal;\">Highest qualification: \n");
      out.write("                        ");
