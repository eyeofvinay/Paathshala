  ...
  border-radius: 3px;
    ...
    <div class="topbar">
        ...
        <div class="topbar" style="margin-left:1350px; width: 50px;  align-content: center; margin-top: -58px;height: 20px;">
            <a href="ViewReview.jsp" class="links" style="color:#f4f4f4; font-size: 16px; font-family: Verdana;">View Review</a>
        </div>
        ...
        <div class="topbar" style="margin-left:1150px; width: 50px;  align-content: center; margin-top: -30px; height: 20px;">
            <a href="TeacherPage.jsp" class="links" style="color:#f4f4f4; font-size: 16px; padding-top: 30px; font-family: Verdana;">Home</a>
        </div>
    </div>
            ...
            <table>
                <tr>
                    <td class="tdtheme">
                        ...
                        <br>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal; color: slategray;">+91 
                        <%=contact%>
                        </font>
                        <br><br>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal;">Highest qualification:</font>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal; color: slategray; align-content: center;"> 
                        <%=qualification%>
                        </font>
                        <br><br>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal;">Teaching Experience:</font>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal; color: slategray; align-content: center;"> 
                        <%=experience%>
                        </font>
                        <br><br>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal;">Description: </font>
                        <font style="font-family:Arial;font-size:21px; font-weight: normal; color: slategray; align-content: center;">
                        <%=des%>
                        </font>
                    </td>
